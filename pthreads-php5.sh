...
./configure --prefix=/usr --with-mysql --enable-maintainer-zts --enable-sockets --with-openssl=/home/user/build-openssl --with-pdo-mysql --with-apxs2=/usr/bin/apxs --enable-cli
